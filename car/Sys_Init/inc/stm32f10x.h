...
/*-------------added by L.D. Dong, Jul. 12, 2014----------*/
/** 
  * @brief Unique Identifer of MCU
  *
  */

typedef struct UIDMCU_TypeDef
{
  __IO uint16_t id0;
  __IO uint16_t id1;
  __IO uint16_t id2;
...
/*----------- added by l.d. dong, Jul. 12, 2014 */
#define UIDMCU_BASE              ((uint32_t)0x1FFFF7E8)  
...
/*------- added by L.D. Dong -----------------*/
#define UIDMCU               ((UIDMCU_TypeDef *) UIDMCU_BASE)
